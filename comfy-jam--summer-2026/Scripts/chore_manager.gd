...
var chores_dict = [
	...
	["Set Table",1,5,2200,1],
	["Do Laundry",3,30,2600,2],
	["Dust Bookshelf",2,20,600,2],
	["Organize Cabinet",2,20,1800,1],
	["Hang Clothes",3,30,1600,2],
	["Do Summer Homework",5,55,3200,1],
	["Replace Water",3,30,4900,2],
	["Fix the Light",1,10,2800,2],
	["Unclog the Sink",3,30,4000,1]
]

var day_0_chores = [0, 1, 2]
var day_1_chores = [0, 1, 2, 3, 4, 5]
